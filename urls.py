...
urlpatterns = [
    ...
    path('activate/student/<uidb64>/<token>/<name>', views.activatestudent, name='activatestudent'),
    path('activate/admin/<uidb64>/<token>/<name>', views.activateadmin, name='activateadmin'),
